...
\headerbox{Summary}{name=summary,column=0,row=0}{
	 ...
	 \textbf{Bottom Up Approach:} One dimensional neural-field models can admit traveling fronts/pulses.
	 \vspace{.2cm}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Wave Response}{name=response,column=2,row=0}
{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{References and Funding}{name=references,column=3,below=results,above=bottom}
{
